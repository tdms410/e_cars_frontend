...
function AddToCartButton({ product }) {
    ...
    return (
        <>
            <button
                className="text-sm font-semibold p-1 mt-2.5 w-32 transition ease-in duration-200 bg-white hover:bg-red-700 text-black hover:text-white border border-gray-300"
