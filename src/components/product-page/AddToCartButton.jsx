...
function AddToCartButton({ product }) {
    ...
    return (
        <>
            ...
            <button
                className="w-full font-semibold md:w-60 py-2 px-8 md:p-2 text-sm mt-4 transition ease-in duration-200 bg-white hover:bg-red-700 hover:text-white text-black border hover:border-gray-800 border-gray-300"
